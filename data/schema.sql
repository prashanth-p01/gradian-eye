-- GuardianEye SQLite Database Schema (18 Table Entities)
...
CREATE TABLE IF NOT EXISTS survivor_evidences (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  sector_code TEXT NOT NULL,
  object_id TEXT,
...
CREATE TABLE IF NOT EXISTS rescue_priorities (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  sector_code TEXT UNIQUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS food_safety_scans (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS search_coverages (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  disaster_id INTEGER,
